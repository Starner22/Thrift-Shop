...
// 1. Get all user inputs from the URL
...
// In a proper OOP approach, this is where you'd chain your Decorator classes.
// For simplicity, we are building the SQL string manually here.

$where_clause = " WHERE p.Is_Product_Shown = TRUE ";
// Search filter
...
// Review filter (NOTE: Assumes you have an Average_Review_Score column)
...
// In a proper OOP approach, this is where you'd use your SortingStrategy classes.
// For simplicity, we are using an if/else block here.
...
<html>
    <head>
        <title>All Products – Thrift Store</title>
    ...
    <body>
        ...
        <div class="browse-main container">
            <aside class="sidebar">
                <form method="GET" action="http://localhost/Thrift/Frontend_html/customer_browse_all.php">
                    <?php 
            ...
            <main class="main-product-list">
                <div class="sort-bar">
                    ...
                    <form method="GET" action="http://localhost/Thrift/Frontend_html/customer_browse_all.php" class="sort-form">
